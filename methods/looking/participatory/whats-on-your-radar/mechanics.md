---
name: whats-on-your-radar-mechanics
description: Facilitation cheat sheet for running What's on Your Radar. Maps to the method mechanics framework in modes/mechanics/method-facilitation-mechanics.md. Use when preparing to facilitate or when in Facilitating mode.
---
...
- Build shared understanding from individual truth, not from averaging
...
- **Individual radars** — one per participant, showing personal priorities across all categories
- **Group radar** ("What's on Our Radar") — a collaboratively negotiated artifact (workshop path only)
- **Patterns across radars** — convergence, divergence, and gaps (research path or post-workshop analysis)
...
| Step | What to say |
|---|---|
| Share the directive | "We're exploring [directive]. That's the frame for everything we're about to do." |
| State the purpose | "Before we talk as a group about what matters, we want to know what matters to each of you individually. That's what this activity is designed to surface." |
| Set expectations | "You'll work on your own first, then we'll compare. The whole thing takes about [time]." |
...
| Explain placement | "Now you're going to place your stickies onto your personal radar using three rings: Most at the center — one item only — Some in the middle ring, and Least in the outer ring. Only one item can sit at the center of each segment. The middle and outer rings can hold as many or as few items as feels right — there's no minimum or maximum for either." |
...
| Step | What to do |
|---|---|
| Generate | Participants write responses individually. No discussion. Target: 2–4 stickies per category. Minimum 2. |
...
- **Group size:** 3–5 people per group radar. Larger groups take significantly longer to negotiate.
- **Number of categories:** 2–6. Default is 4. More than 6 makes the session unwieldy.
