...
Each method file should follow a consistent structure:

1. **Frontmatter** — status, category, phase, and tags
...
Place your method file in the appropriate subfolder based on its primary phase and approach type. Name it `method-[name].md`.
